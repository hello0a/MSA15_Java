...
public class X {
	...
	class Y {
		...
		void method1() {
			System.out.println("Y의 메서드");
			System.out.println("Y에서 X클래스의 static 변수 접근 " + xValue2);
		}
		static void method2() {
			System.out.println("Y의 static 메서드");
		}
	}
	// static 이너 클래스
	// static 멤버 사용 가능
	static class Z {
		...
		void method1() {
			System.out.println("Z의 메서드");
		}
		static void method2() {
			System.out.println("Z의 static 메서드");
		}
	}
	// 로컬 클래스
	// 메서드 안에 정의한 클래스
	// - 메서드가 실행될 때만 사용되는 이너 클래스
	void method() {
		class L {
			int value;
			static int value2;
			...
			void method1() {
				System.out.println("L의 메서드");
			}
			static void method2() {
				System.out.println("L의 static 메서드");
			}
		}
		L l = new L();
		l.value = 10;
